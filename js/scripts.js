...
jQuery(document).ready(function() {
	...
	/*jQuery(".hoverIMG").each(function(index) {
		var heightImg = "height: " + jQuery(this).height() + "px";
		var widthImg = "width: " + jQuery(this).width() + "px";
		var imgProp = heightImg + "; " + widthImg + ";";
		jQuery(this).parent().parent().attr("style", imgProp);
		console.log(index + " : " + heightImg + widthImg);
	});*/
